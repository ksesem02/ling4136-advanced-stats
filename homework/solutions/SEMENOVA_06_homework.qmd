...
my_priors <- c(
  prior(normal(100, 57), class = Intercept),
  prior(normal(0, 40), class = b),
  prior(normal(0, 30), class = sigma)#i haven't done anything to count the difference between similar and different tho?
) #idk what to do with the sigma values as well??
